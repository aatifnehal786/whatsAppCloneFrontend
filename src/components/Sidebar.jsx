...
const Sidebar = () => {
  ...
  const {activeTab,setActivetab} = layoutStore();
  ...
  const sidebarContent = (
    ...
    <FaWhatsapp className={`h-6 w-6 ${activeTab === 'chats' ? theme === 'dark' ? 'text-gray-800' : '' : theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`} />
    
    </Link>
    <Link to="/status"
    className={`${isMobile ? '' : 'mb-8'} ${activeTab === 'status' && 'bg-gray-300 shadow-sm p-2 rounded-full'} focus:outline-none`}>
    <MdOutlineRadioButtonChecked className={`h-6 w-6 ${activeTab === 'status' ? theme === 'dark' ? 'text-gray-800' : '' : theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`} />
    ...
    className={`${isMobile ? '' : 'mb-8'} ${activeTab === 'profile' && 'bg-gray-300 shadow-sm p-2 rounded-full'} focus:outline-none`}>
     ...
     : (<FaUserCircle className={`h-6 w-6 ${activeTab === 'profile' ? theme === 'dark' ? 'text-gray-800' : '' : theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`} />)}
     </Link>
    <Link to="/setting"
    className={`${isMobile ? '' : 'mb-8'} ${activeTab === 'setting' && 'bg-gray-300 shadow-sm p-2 rounded-full'} focus:outline-none`}>
    <FaCog className={`h-6 w-6 ${activeTab === 'setting' ? theme === 'dark' ? 'text-gray-800' : '' : theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`} />
